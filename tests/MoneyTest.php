...
class MoneyTest extends TestCase
{
    public function testFactoryMethods()
    {
        ...
        $this->assertEquals(Money::JPY(25), Money::JPY(10)->add(Money::JPY(15)));
    }
    ...
    public function testSameCurrency()
    {
        ...
        $this->assertFalse($m->isSameCurrency(new Money(100, new Currency('JPY'))));
    }
    ...
    public function testDifferentCurrenciesCannotBeCompared()
    {
        ...
        $m2 = new Money(100, new Currency('JPY'));
    ...
    {
        $m1 = new Money(100, new Currency('USD'));
        $m2 = new Money(350, new Currency('JPY'));

        $this->assertEquals($m1->convert(new Currency('JPY'), 3.5), $m2);
    }
    ...
    {
        return [
            ['¥1.548,48', 'JPY', 154848.25895, 'tr_TR', 'Example: ' . __LINE__],
    ...
    {
        return [
            ['¥1.548,48', 'JPY', 154848.25895, 'Example: ' . __LINE__],
